...
import micIcon from "./assets/mic.png"; // 🎤 Add a mic icon in assets
...
const WeatherDetails = ({ icon, temp, city, country, latitude, longitude, humidity, wind }) => {
  return (
    <>
      <div className="image"><img src={icon} alt="weather" /></div>
      <div className="temp">{temp}°C</div>
      <div className="location">{city}</div>
      <div className="country">{country}</div>
      <div className="cord">
        <div><span className="lat">Latitude:</span><span>{latitude}</span></div>
        <div><span className="log">Longitude:</span><span>{longitude}</span></div>
      </div>
      <div className="data-container">
        <div className="element">
          <img src={humidityIcon} alt="humidity" className="icon" />
          <div className="data"><div className="humidity-percent">{humidity} %</div><div className="text">Humidity</div></div>
        </div>
        <div className="element">
          <img src={windIcon} alt="wind" className="icon" />
          <div className="data"><div className="wind-percent">{wind} km/h</div><div className="text">Wind Speed</div></div>
        </div>
      </div>
    </>
  );
...
function App() {
  ...
  const search = async () => {
    ...
    try {
      ...
      let fullCountryName = await getCountryName(data.sys.country);
      setCity(data.name);
  ...
  return (
    <div className="container">
      <div className="input-container">
        ...
        />
         <div className="mic-icon" onClick={handleVoiceInput}>
